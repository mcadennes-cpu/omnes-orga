...
8. ⏳ **Étape 8 — PRÉPARATION COMMENCÉE (26/08/2026)** — Ouverture à tous, activation des 26 comptes remplaçants, extinction de l'appli Bolt. **8A-1 (resynchronisation différentielle) est faite et éprouvée** ; l'ordre des opérations du soir de la bascule est arrêté et testé. Détail dans « Suivi d'avancement ».
