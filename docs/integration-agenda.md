...
- ⏳ **Étape 6 / MOD-2 — EN COURS.** Arbitrée le 03/08/2026 ; MOD2-A à MOD2-C livrées le 06/08/2026, MOD2-D le 24/08/2026. Restent MOD2-E (bandeau éphémère, mort d'`undo_buffer`), MOD2-F (vocabulaire, fin des `alert()`) et MOD2-G (Ctrl/Cmd+Z, optionnel).
