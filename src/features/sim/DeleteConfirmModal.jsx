...
/**
 * Modale de confirmation de suppression d'un dossier ou fichier SIM.
 * Gere son propre DELETE Supabase. Pour un fichier, supprime aussi du bucket
 * Storage (best-effort). Pour un dossier non vide, la contrainte SQL
...
export default function DeleteConfirmModal({ kind, id, name, onClose, onDeleted }) {
  ...
  async function handleDelete() {
    ...
    const table = kind === 'folder' ? 'sim_dossiers' : 'sim_fichiers'
